    ...
    prompt = Prompt.from_messages(
        ...
        messages=[
            ChatMessage(
                ...
                content="You are a helpful assistant to calculate the result of expression."
                'Ensure that your final response must be json format, like: "result": 32.67',
            ),
