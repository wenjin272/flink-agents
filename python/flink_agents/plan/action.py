...
def process_tool_response(event: ToolResponseEvent, ctx: RunnerContext) -> None:
...
BUILT_IN_ACTIONS = [PROCESS_CHAT_REQUEST, PROCESS_TOOL_REQUEST, PROCESS_TOOL_RESPONSE]
