...
public interface BaseLongTermMemory extends AutoCloseable {
    ...
    /**
     * Switches the context for the long-term memory operations. This allows the same memory
     * instance to be used for different key by isolating data based on the provided job ID and key.
     *
