...
public class PythonEvent extends Event {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(event, other.event) && Objects.equals(this.eventType, other.eventType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), Arrays.hashCode(event), eventType);
    }
}
