...
tar czf ${RELEASE_DIR}/flink-agents-${RELEASE_VERSION}-src.tgz flink-agents-$RELEASE_VERSION
gpg --armor --detach-sig ${RELEASE_DIR}/flink-agents-$RELEASE_VERSION-src.tgz
cd ${RELEASE_DIR}
$SHASUM flink-agents-$RELEASE_VERSION-src.tgz > flink-agents-$RELEASE_VERSION-src.tgz.sha512
